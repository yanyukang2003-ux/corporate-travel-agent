...
- Evaluation ID：`eval-0c8b2ce9-d01a-49c5-9d85-c59057acd54e`
...
- 案例：2；每例 1 次；完成 2 次
- 源轨迹 SHA-256：`853386642ba0e4a339d735932b96981bc015b42eafc3d0c50f62ab29d89d7cb3`
...
| 指标 | 均值 | P50 | P95 | 最大值 |
|---|---:|---:|---:|---:|
| 整次运行耗时（ms） | 5959.996 | 2593.405 | 9326.587 | 9326.587 |
| 工具步骤耗时（ms） | 5958.370 | 2591.961 | 9324.779 | 9324.779 |
...
| 输出 Token 总量 | measured | 818.000000 |
| 每运行总 Token 均值 | measured | 1457.500000 |
| 估算总费用 | measured | 0.014010 |
| 成功任务单位费用 | measured | 0.003958 |
