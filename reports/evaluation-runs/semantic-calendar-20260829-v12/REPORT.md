...
| H-02 | FAIL | 0/3 | 这周五还是下周五：不许自己挑一个 |
| H-03a | PASS | 3/3 | 8/5 在该日之前 = 今年 8 月 5 日 |
...
- 追问：还差这几件事我就能去查了：哪天出发、最晚什么时候要到。
- **question_names_the_ambiguity**：还差这几件事我就能去查了：哪天出发、最晚什么时候要到。
