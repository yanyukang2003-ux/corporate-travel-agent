...
- External calls: `5` / `12` maximum (`4` baseline)
- Provider retries: `1` / `2` maximum per operation
- Final state: `RECONFIRMATION_REQUIRED`
- Task failure: `none`
- Revalidation: `PRICE_CHANGED`
- Flight price: `214.20 USD`
- Hotel: `Hotel Riu Plaza Manhattan Times Square` at `531.82 USD` per night
- Total: `1277.84 USD`
