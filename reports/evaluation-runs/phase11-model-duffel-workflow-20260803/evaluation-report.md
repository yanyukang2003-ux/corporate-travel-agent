...
- Parameter hallucination: model exposure `measured`; failed attempts 1
- Shadow hallucination: model exposure `not_exposed`; evidence-proxy failures 1
...
- attempt 1: FAIL, state `NEEDS_STRUCTURED_INPUT`, options 0, cost `$None`
- attempt 2: PASS, state `WAITING_FOR_USER`, options 3, cost `$0.01280125`
- attempt 3: PASS, state `WAITING_FOR_USER`, options 3, cost `$0.01253125`
