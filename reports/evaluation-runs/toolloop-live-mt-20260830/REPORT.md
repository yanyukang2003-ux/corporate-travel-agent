...
- started_at: `2026-08-30T14:53:42.546192+00:00`
...
- result: **6/6 PASS**
- 模型调用: 24 次，估算 **0.054009165 USD**
- 供应商搜索: 14 次

> LM-02 originally failed because the model attempted Shanghai→Hangzhou without dates; the host refused. Rescored: only executed searches count.
...
| LM-04 | WAITING_FOR_USER | 3 | [['Beijing', 'Shanghai'], ['Shanghai', 'Hangzhou']] |
