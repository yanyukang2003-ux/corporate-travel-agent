...
- started_at: `2026-08-27T18:23:43.664627+00:00`
- runner: `semantic-calendar-model-runner-v1`
- model: `deepseek-v4-pro`
- entrypoint: `semantic`
- inventory: `mock`（不碰 Duffel / LiteAPI）
- result: **3/8 PASS**
- 估算费用: **0.008598 USD**（价目表 `model-prices-openai-20260802-v1`，缓存折扣未建模）
...
| H-03d | PASS | 没写年份的 8/5 落在刚过去的日子：不许自动跳到明年 |
