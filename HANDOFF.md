...
**两张表都打完了。下一步要的是拍板，不是继续往下加**——见 §37.7 与 §1.5。

**还欠一笔钱没花：** LLM Judge 60 条至今没重跑，**已经隔了 v12、v13 三轮提示词改动**，
v11 的 4.55 早已作废；而这几轮又往解释事实里加了 `leg2=` / `stay1=` / `fares`
——正好是 Judge 打分的那部分。见 §37.7。
...
```
pytest 724 / ruff（src tests examples migrations）   全过（2026-08-29，§37）
...
*本轮见 §37（一次多段报价，多城方案收官）；上一轮 §36（语义层出航段列表）；再上 §35、§34、§33、§32、§31；再上 §29；再上 §28、§27、§26、§25；A–F 见 §19；G 见 §20；H 见 §21；I 见 §22。*
