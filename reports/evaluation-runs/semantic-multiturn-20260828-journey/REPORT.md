...
- started_at: `2026-08-28T21:11:06.319250+00:00`
...
- result: **4/5 PASS**（每条跑 2 次，全部通过才记 PASS）
- 模型调用: 27 次，估算 **0.041945 USD**
...
- 轮1：`9月16号中午12点前到上海就行，返程9月20号晚上8点前到北京` → NO_FEASIBLE_OPTION
- 最终状态：`NO_FEASIBLE_OPTION` · 航段 `[('Beijing', 'Shanghai'), ('杭州', 'Beijing')]`
- **legs**：[('Beijing', 'Shanghai'), ('杭州', 'Beijing')]
